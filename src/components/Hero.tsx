...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-between overflow-hidden pt-16">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center flex-1 flex flex-col justify-center">
      ...
      <div className="relative z-10 w-full py-6 text-center border-t border-white/10 bg-background/40 backdrop-blur-md">
        <p className="text-sm text-muted-foreground">
          © {new Date().getFullYear()} <span className="text-primary font-semibold">DeepZoomer</span> • Crafted with curiosity
        </p>
